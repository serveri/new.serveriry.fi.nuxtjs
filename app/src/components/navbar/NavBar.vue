      ...
      <div class="px-6 lg:px-16 xl:px-32">
         <div class="relative flex items-center justify-between">
            ...
            <div class="absolute inset-y-0 left-0 flex items-center md:hidden">
               <div
                  class="inline-flex items-center justify-center rounded-md p-2 cursor-pointer text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-hidden focus:ring-2 focus:ring-inset focus:ring-white"
                  @click="toggleMenu"
               >
