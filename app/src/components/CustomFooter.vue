         ...
         <div class="sm:flex sm:items-stretch sm:justify-between">
            ...
            <div class="flex m-6 space-x-6 justify-center sm:justify-end sm:m-0 sm:w-1/3">
               <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  ...
                  <span class="sr-only" aria-label="Facebook page">Facebook page</span>
               </a>
               <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                     <path
                  ...
                  <span class="sr-only" aria-label="Instagram page">Instagram page</span>
               </a>
               <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                     <path
                  ...
                  <span class="sr-only" aria-label="Twitter page">Twitter page</span>
               </a>
               <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                     <path
                  ...
                  <span class="sr-only" aria-label="GitHub account">GitHub account</span>
               </a>
               <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                     <path
                  ...
                  <span class="sr-only" aria-label="Dribbbel account">Dribbbel account</span>
               </a>
            </div>
         </div>
      </div>
