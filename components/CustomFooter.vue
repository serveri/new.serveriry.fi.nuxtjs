        ...
        <div class="p-4 sm:p-6 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div class="mx-2 sm:mx-0 flex items-stretch justify-between">
                ...
                <div class="sm:w-1/3">
                    ...
                    <h2
                        class="mb-6 text-md font-semibold text-gray-900 dark:text-white"
                    >
                        Y: 1085522-1
                    </h2>
                    <p
                        class="mb-1 text-md font-mediumfont-bold text-gray-9font-bold00 dark:text-white"
                    >
                        Microkatu 1
                    </p>
                    <p
                        class="mb-1 text-md font-mediumfont-bold text-gray-900 dark:text-white"
                    >
                        PL 1627
                    </p>
                    <p
            ...
            <div class="sm:flex sm:items-stretch sm:justify-between">
                ...
                <div class="sm:hidden sm:w-1/3">
                    <a
                        ...
                        aria-label="Etusivu"
                    >
                        <ServerLogoRound class="h-32" />
                    </a>
                </div>
                <!-- Copyright -->
                <div
                    class="text-sm text-gray-600 text-center dark:text-gray-400 sm:w-1/3 mt-2 sm:mt-0"
                >
                    © {{ date }}
                    <a href="https://serveriry.fi/" class="hover:underline"
                        >Serveri ry</a
                    >
                </div>
                <!-- Social Media-->
                <div
                    class="flex m-6 space-x-6 justify-center sm:justify-end sm:m-0 sm:w-1/3"
                >
                    <a
                        href="#"
                    ...
                    >
                        ...
                        <span class="sr-only" aria-label="Facebook page"
                            >Facebook page</span
                        >
                    </a>
                    <a
                    ...
                    >
                        ...
                        <span class="sr-only" aria-label="Instagram page"
                            >Instagram page</span
                        >
                    </a>
                    <a
                    ...
                    >
                        ...
                        <span class="sr-only" aria-label="Twitter page"
                            >Twitter page</span
                        >
                    </a>
                    <a
                    ...
                    >
                        ...
                        <span class="sr-only" aria-label="GitHub account"
                            >GitHub account</span
                        >
                    </a>
                    <a
                    ...
                    >
                        ...
                        <span class="sr-only" aria-label="Dribbbel account"
                            >Dribbbel account</span
                        >
                    </a>
                </div>
            </div>
